const textData = {
  ...
  29: [
    "Ante  una situación de conflicto maestra o maestro o es quien genera el proceso de mediación en la comunidad educativa, soluciona los conflictos de manera neutral e independiente, este proceso permite desarrollar un ambiente escolar más relajado y productivo.",
  ...
  31: " ",
  32: [
    "Los procesos de prácticas restaurativas en comunidades educativas coadyuvan a la prevención de violencias entre los diferentes actores de la comunidad. Siendo uno de ellos: niñas, niños, adolescentes, es decir, estudiantes, mujeres y hombres, quienes al promover y ser parte de los procesos restaurativos pueden emitir sus opiniones, sus sentimientos ante una situación de conflicto en la que está involucrado directa e indirectamente.",
  ...
  38: [
    "Podemos identificar dos finalidades en el desarrollo de las prácticas restaurativas, la primera de ellas está en la <b> prevención de maltrato, daño u ofensa que puede darse entre pares y no pares</b>, mediante un abordaje asertivo de las situaciones de violencias en la unidad educativa; y, la segunda está en relación con la <b> búsqueda de la responsabilidad, a veces, de la corresponsabilidad y la reparación del daño por parte de la víctima </b>, de la persona que actúa como ofensor y de la comunidad, en general, cuando se ha producido acciones que están en relación con la violencia.",
  ...
  49: [
    "Tomando en cuenta los contenidos desarrollados en el presente cuaderno de formación, llevamos adelante un diagnóstico que permita identificar los tipos de violencias, faltas que afectan a las y los estudiantes dentro de la comunidad educativa.",
...
const titlesData = {
  ...
  15: [
    "El bullying o acoso escolar en la actualidad",
  ...
  38: [
    "Finalidades en el desarrollo de las prácticas restaurativas",
...
const buttonsNameData = {
  ...
  4: "",
  5: [
    "Aspectos fundamentales de la Justicia Restaurativa en la unidad educativa",
  ...
  22: [
    ...
    " Consejo Educativo en la prevención de conflictos.",
    "Estudiantes como protagonistas de las prácticas restaurativas",
  ],
  23: "",
  24: "",
  25: "",
  ...
  36: [
    ...
    "Beneficios de una zona educativa restaurativa",
  ],
  37: "",
  38: "",
  39: "",
